...
type [<AllowNullLiteral>] BoardsRestClient =
    ...
    abstract deleteBoard: project: string * id: int -> Promise<unit>
    /// <summary>Returns information for a board given its unique identifier.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="id">- Board's unique identifier.</param>
    abstract getBoard: project: string * id: int -> Promise<Boards.BoardResponse>
    ...
    abstract getBoards: project: string * ?top: int * ?skip: int -> Promise<ResizeArray<Boards.BoardReference>>
    ...
    abstract updateBoard: updatedBoard: Boards.UpdateBoard * project: string * id: int * eTag: String -> Promise<Boards.BoardResponse>
    ...
    abstract createBoardColumn: boardColumn: Boards.BoardColumnCreate * project: string * board: int -> Promise<Boards.BoardColumnResponse>
    ...
    abstract deleteBoardColumn: project: string * board: int * id: string * forceRemoveItems: bool -> Promise<unit>
    /// <summary>Gets column data for a board given its identifier.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    /// <param name="id">- Column identifier.</param>
    abstract getBoardColumn: project: string * board: int * id: string -> Promise<Boards.BoardColumnResponse>
    /// <summary>Get columns in a board.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    abstract getBoardColumns: project: string * board: int -> Promise<Boards.BoardColumnCollectionResponse>
    ...
    abstract updateBoardColumn: boardColumn: Boards.BoardColumnUpdate * project: string * board: int * id: string * eTag: String -> Promise<Boards.BoardColumnResponse>
    /// <summary>Adds a single item to a board.</summary>
    /// <param name="item">- Item to add to the board.</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    abstract addBoardItem: item: Boards.NewBoardItem * project: string * board: int -> Promise<Boards.BoardItemResponse>
    /// <summary>Gets data for a single board's item.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    /// <param name="id">- Item identifier.</param>
    abstract getBoardItem: project: string * board: int * id: string -> Promise<Boards.BoardItemResponse>
    /// <summary>Get items information for a board given its identifier.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    abstract getBoardItems: project: string * board: int -> Promise<Boards.BoardItemCollectionResponse>
    /// <summary>Removes an item from a board.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    /// <param name="id">- Board Item identifier to remove.</param>
    abstract removeBoardItem: project: string * board: int * id: string -> Promise<unit>
    ...
    abstract updateBoardItem: updateItemDef: Boards.UpdateBoardItem * project: string * board: int * id: string * eTag: String -> Promise<Boards.BoardItemResponse>
    ...
    abstract updateBoardItems: batchRequest: Boards.BoardItemBatchOperation * project: string * board: int -> Promise<Boards.BoardItemCollectionResponse>
    /// <summary>Creates a new row on a board.</summary>
    /// <param name="boardRow">- Row data.</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    abstract createBoardRow: boardRow: Boards.BoardRowCreate * project: string * board: int -> Promise<Boards.BoardRowResponse>
    ...
    abstract deleteBoardRow: project: string * board: int * id: string * forceRemoveItems: bool -> Promise<unit>
    /// <summary>Gets a row given its identifier and board.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    /// <param name="id">- Board row identifier.</param>
    abstract getBoardRow: project: string * board: int * id: string -> Promise<Boards.BoardRowResponse>
    /// <summary>Get rows in a board given its identifier.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">- Board identifier.</param>
    abstract getBoardRows: project: string * board: int -> Promise<Boards.BoardRowCollectionResponse>
    ...
    abstract updateBoardRow: boardRow: Boards.BoardRowUpdate * project: string * board: int * id: string * eTag: String -> Promise<Boards.BoardRowResponse>
    /// <summary>Creates a new sync for a column on a board.</summary>
    /// <param name="boardSync">-</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="board">-</param>
    /// <param name="column">-</param>
    abstract createBoardSyncAction: boardSync: Boards.BoardItemStateSyncCreate * project: string * board: int * column: string -> Promise<Boards.BoardItemStateSync>
