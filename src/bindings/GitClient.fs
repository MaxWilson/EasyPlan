...
type [<AllowNullLiteral>] GitRestClient =
    ...
    abstract getChanges: commitId: string * repositoryId: string * ?project: string * ?top: int * ?skip: int -> Promise<Git.GitCommitChanges>
    ...
    /// <param name="repositoryId">- ID of the repository.</param>
    abstract getCherryPick: project: string * cherryPickId: int * repositoryId: string -> Promise<Git.GitCherryPick>
    ...
    abstract getCommitDiffs: repositoryId: string * ?project: string * ?diffCommonCommit: bool * ?top: int * ?skip: int * ?baseVersionDescriptor: Git.GitBaseVersionDescriptor * ?targetVersionDescriptor: Git.GitTargetVersionDescriptor -> Promise<Git.GitCommitDiffs>
    /// <summary>Retrieve a particular commit.</summary>
    /// <param name="commitId">- The id of the commit.</param>
    /// <param name="repositoryId">- The id or friendly name of the repository. To use the friendly name, projectId must also be specified.</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="changeCount">- The number of changes to include in the result.</param>
    abstract getCommit: commitId: string * repositoryId: string * ?project: string * ?changeCount: int -> Promise<Git.GitCommit>
    ...
    abstract getPushCommits: repositoryId: string * pushId: int * ?project: string * ?top: int * ?skip: int * ?includeLinks: bool -> Promise<ResizeArray<Git.GitCommitRef>>
    ...
    abstract getCommitsBatch: searchCriteria: Git.GitQueryCommitsCriteria * repositoryId: string * ?project: string * ?skip: int * ?top: int * ?includeStatuses: bool -> Promise<ResizeArray<Git.GitCommitRef>>
    ...
    /// <param name="project">- Project ID or project name</param>
    /// <param name="includeLinks">- True to include links.</param>
    abstract getForkSyncRequest: repositoryNameOrId: string * forkSyncOperationId: int * ?project: string * ?includeLinks: bool -> Promise<Git.GitForkSyncRequest>
    ...
    abstract getImportRequest: project: string * repositoryId: string * importRequestId: int -> Promise<Git.GitImportRequest>
    ...
    abstract updateImportRequest: importRequestToUpdate: Git.GitImportRequest * project: string * repositoryId: string * importRequestId: int -> Promise<Git.GitImportRequest>
    ...
    /// <param name="includeLinks">- True to include links</param>
    abstract getMergeRequest: project: string * repositoryNameOrId: string * mergeOperationId: int * ?includeLinks: bool -> Promise<Git.GitMerge>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract createAttachment: content: obj option * fileName: string * repositoryId: string * pullRequestId: int * ?project: string -> Promise<Git.Attachment>
    /// <summary>Delete a pull request attachment.</summary>
    /// <param name="fileName">- The name of the attachment to delete.</param>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract deleteAttachment: fileName: string * repositoryId: string * pullRequestId: int * ?project: string -> Promise<unit>
    /// <summary>Get the file content of a pull request attachment.</summary>
    /// <param name="fileName">- The name of the attachment.</param>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getAttachmentContent: fileName: string * repositoryId: string * pullRequestId: int * ?project: string -> Promise<ArrayBuffer>
    /// <summary>Get a list of files attached to a given pull request.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getAttachments: repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<Git.Attachment>>
    /// <summary>Get the file content of a pull request attachment.</summary>
    /// <param name="fileName">- The name of the attachment.</param>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getAttachmentZip: fileName: string * repositoryId: string * pullRequestId: int * ?project: string -> Promise<ArrayBuffer>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract createLike: repositoryId: string * pullRequestId: int * threadId: int * commentId: int * ?project: string -> Promise<unit>
    ...
    /// <param name="commentId">- The ID of the comment.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract deleteLike: repositoryId: string * pullRequestId: int * threadId: int * commentId: int * ?project: string -> Promise<unit>
    ...
    /// <param name="commentId">- The ID of the comment.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getLikes: repositoryId: string * pullRequestId: int * threadId: int * commentId: int * ?project: string -> Promise<ResizeArray<WebApi.IdentityRef>>
    ...
    /// <param name="skip">- Number of commits to skip.</param>
    abstract getPullRequestIterationCommits: repositoryId: string * pullRequestId: int * iterationId: int * ?project: string * ?top: int * ?skip: int -> Promise<ResizeArray<Git.GitCommitRef>>
    /// <summary>Get the commits for the specified pull request.</summary>
    /// <param name="repositoryId">- ID or name of the repository.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestCommits: repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<Git.GitCommitRef>>
    /// <summary>Retrieve one conflict for a pull request by ID</summary>
    /// <param name="repositoryId">-</param>
    /// <param name="pullRequestId">-</param>
    /// <param name="conflictId">-</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestConflict: repositoryId: string * pullRequestId: int * conflictId: int * ?project: string -> Promise<Git.GitConflict>
    ...
    abstract getPullRequestConflicts: repositoryId: string * pullRequestId: int * ?project: string * ?skip: int * ?top: int * ?includeObsolete: bool * ?excludeResolved: bool * ?onlyResolved: bool -> Promise<ResizeArray<Git.GitConflict>>
    ...
    /// <param name="conflictId">-</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestConflict: conflict: Git.GitConflict * repositoryId: string * pullRequestId: int * conflictId: int * ?project: string -> Promise<Git.GitConflict>
    /// <summary>Update multiple merge conflict resolutions</summary>
    /// <param name="conflictUpdates">-</param>
    /// <param name="repositoryId">-</param>
    /// <param name="pullRequestId">-</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestConflicts: conflictUpdates: ResizeArray<Git.GitConflict> * repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<Git.GitConflictUpdateResult>>
    ...
    abstract getPullRequestIterationChanges: repositoryId: string * pullRequestId: int * iterationId: int * ?project: string * ?top: int * ?skip: int * ?compareTo: int -> Promise<Git.GitPullRequestIterationChanges>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestIteration: repositoryId: string * pullRequestId: int * iterationId: int * ?project: string -> Promise<Git.GitPullRequestIteration>
    ...
    abstract getPullRequestIterations: repositoryId: string * pullRequestId: int * ?project: string * ?includeCommits: bool -> Promise<ResizeArray<Git.GitPullRequestIteration>>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract createPullRequestIterationStatus: status: Git.GitPullRequestStatus * repositoryId: string * pullRequestId: int * iterationId: int * ?project: string -> Promise<Git.GitPullRequestStatus>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract deletePullRequestIterationStatus: repositoryId: string * pullRequestId: int * iterationId: int * statusId: int * ?project: string -> Promise<unit>
    ...
    /// <param name="statusId">- ID of the pull request status.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestIterationStatus: repositoryId: string * pullRequestId: int * iterationId: int * statusId: int * ?project: string -> Promise<Git.GitPullRequestStatus>
    /// <summary>Get all the statuses associated with a pull request iteration.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="iterationId">- ID of the pull request iteration.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestIterationStatuses: repositoryId: string * pullRequestId: int * iterationId: int * ?project: string -> Promise<ResizeArray<Git.GitPullRequestStatus>>
    ...
    /// <param name="iterationId">- ID of the pull request iteration.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestIterationStatuses: patchDocument: WebApi.JsonPatchDocument * repositoryId: string * pullRequestId: int * iterationId: int * ?project: string -> Promise<unit>
    ...
    abstract createPullRequestLabel: label: Core.WebApiCreateTagRequestData * repositoryId: string * pullRequestId: int * ?project: string * ?projectId: string -> Promise<Core.WebApiTagDefinition>
    ...
    /// <param name="project">- Project ID or project name</param>
    /// <param name="projectId">- Project ID or project name.</param>
    abstract deletePullRequestLabels: repositoryId: string * pullRequestId: int * labelIdOrName: string * ?project: string * ?projectId: string -> Promise<unit>
    ...
    /// <param name="project">- Project ID or project name</param>
    /// <param name="projectId">- Project ID or project name.</param>
    abstract getPullRequestLabel: repositoryId: string * pullRequestId: int * labelIdOrName: string * ?project: string * ?projectId: string -> Promise<Core.WebApiTagDefinition>
    /// <summary>Get all the labels assigned to a pull request.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="projectId">- Project ID or project name.</param>
    abstract getPullRequestLabels: repositoryId: string * pullRequestId: int * ?project: string * ?projectId: string -> Promise<ResizeArray<Core.WebApiTagDefinition>>
    /// <summary>Get external properties of the pull request.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestProperties: repositoryId: string * pullRequestId: int * ?project: string -> Promise<obj option>
    ...
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestProperties: patchDocument: WebApi.JsonPatchDocument * repositoryId: string * pullRequestId: int * ?project: string -> Promise<obj option>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract createPullRequestReviewer: reviewer: Git.IdentityRefWithVote * repositoryId: string * pullRequestId: int * reviewerId: string * ?project: string -> Promise<Git.IdentityRefWithVote>
    /// <summary>Add reviewers to a pull request.</summary>
    /// <param name="reviewers">- Reviewers to add to the pull request.</param>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract createPullRequestReviewers: reviewers: ResizeArray<WebApi.IdentityRef> * repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<Git.IdentityRefWithVote>>
    /// <summary>Remove a reviewer from a pull request.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="reviewerId">- ID of the reviewer to remove.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract deletePullRequestReviewer: repositoryId: string * pullRequestId: int * reviewerId: string * ?project: string -> Promise<unit>
    /// <summary>Retrieve information about a particular reviewer on a pull request</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="reviewerId">- ID of the reviewer.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestReviewer: repositoryId: string * pullRequestId: int * reviewerId: string * ?project: string -> Promise<Git.IdentityRefWithVote>
    /// <summary>Retrieve the reviewers for a pull request</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestReviewers: repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<Git.IdentityRefWithVote>>
    ...
    /// <param name="reviewerId">- ID of the reviewer.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestReviewer: reviewer: Git.IdentityRefWithVote * repositoryId: string * pullRequestId: int * reviewerId: string * ?project: string -> Promise<Git.IdentityRefWithVote>
    ...
    /// <param name="pullRequestId">- ID of the pull request</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestReviewers: patchVotes: ResizeArray<Git.IdentityRefWithVote> * repositoryId: string * pullRequestId: int * ?project: string -> Promise<unit>
    /// <summary>Retrieve a pull request.</summary>
    /// <param name="pullRequestId">- The ID of the pull request to retrieve.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestById: pullRequestId: int * ?project: string -> Promise<Git.GitPullRequest>
    ...
    abstract getPullRequestsByProject: project: string * searchCriteria: Git.GitPullRequestSearchCriteria * ?maxCommentLength: int * ?skip: int * ?top: int -> Promise<ResizeArray<Git.GitPullRequest>>
    ...
    abstract getPullRequest: repositoryId: string * pullRequestId: int * ?project: string * ?maxCommentLength: int * ?skip: int * ?top: int * ?includeCommits: bool * ?includeWorkItemRefs: bool -> Promise<Git.GitPullRequest>
    /// <summary>Retrieve all pull requests matching a specified criteria.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request's target branch.</param>
    /// <param name="searchCriteria">- Pull requests will be returned that match this search criteria.</param>
    /// <param name="project">- Project ID or project name</param>
    ...
    /// <param name="skip">- The number of pull requests to ignore. For example, to retrieve results 101-150, set top to 50 and skip to 100.</param>
    /// <param name="top">- The number of pull requests to retrieve.</param>
    abstract getPullRequests: repositoryId: string * searchCriteria: Git.GitPullRequestSearchCriteria * ?project: string * ?maxCommentLength: int * ?skip: int * ?top: int -> Promise<ResizeArray<Git.GitPullRequest>>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequest: gitPullRequestToUpdate: Git.GitPullRequest * repositoryId: string * pullRequestId: int * ?project: string -> Promise<Git.GitPullRequest>
    ...
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract sharePullRequest: userMessage: Git.ShareNotificationContext * repositoryId: string * pullRequestId: int * ?project: string -> Promise<unit>
    /// <summary>Create a pull request status.</summary>
    /// <param name="status">- Pull request status to create.</param>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract createPullRequestStatus: status: Git.GitPullRequestStatus * repositoryId: string * pullRequestId: int * ?project: string -> Promise<Git.GitPullRequestStatus>
    /// <summary>Delete pull request status.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="statusId">- ID of the pull request status.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract deletePullRequestStatus: repositoryId: string * pullRequestId: int * statusId: int * ?project: string -> Promise<unit>
    ...
    /// <param name="statusId">- ID of the pull request status.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestStatus: repositoryId: string * pullRequestId: int * statusId: int * ?project: string -> Promise<Git.GitPullRequestStatus>
    /// <summary>Get all the statuses associated with a pull request.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestStatuses: repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<Git.GitPullRequestStatus>>
    /// <summary>Update pull request statuses collection. The only supported operation type is \`remove\`.</summary>
    /// <param name="patchDocument">- Operations to apply to the pull request statuses in JSON Patch format.</param>
    /// <param name="repositoryId">- The repository ID of the pull request’s target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract updatePullRequestStatuses: patchDocument: WebApi.JsonPatchDocument * repositoryId: string * pullRequestId: int * ?project: string -> Promise<unit>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract createComment: comment: Git.Comment * repositoryId: string * pullRequestId: int * threadId: int * ?project: string -> Promise<Git.Comment>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract deleteComment: repositoryId: string * pullRequestId: int * threadId: int * commentId: int * ?project: string -> Promise<unit>
    ...
    /// <param name="commentId">- ID of the comment.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getComment: repositoryId: string * pullRequestId: int * threadId: int * commentId: int * ?project: string -> Promise<Git.Comment>
    /// <summary>Retrieve all comments associated with a specific thread in a pull request.</summary>
    /// <param name="repositoryId">- The repository ID of the pull request's target branch.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="threadId">- ID of the thread.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getComments: repositoryId: string * pullRequestId: int * threadId: int * ?project: string -> Promise<ResizeArray<Git.Comment>>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract updateComment: comment: Git.Comment * repositoryId: string * pullRequestId: int * threadId: int * commentId: int * ?project: string -> Promise<Git.Comment>
    ...
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract createThread: commentThread: Git.GitPullRequestCommentThread * repositoryId: string * pullRequestId: int * ?project: string -> Promise<Git.GitPullRequestCommentThread>
    ...
    abstract getPullRequestThread: repositoryId: string * pullRequestId: int * threadId: int * ?project: string * ?iteration: int * ?baseIteration: int -> Promise<Git.GitPullRequestCommentThread>
    ...
    abstract getThreads: repositoryId: string * pullRequestId: int * ?project: string * ?iteration: int * ?baseIteration: int -> Promise<ResizeArray<Git.GitPullRequestCommentThread>>
    ...
    /// <param name="project">- Project ID or project name</param>
    abstract updateThread: commentThread: Git.GitPullRequestCommentThread * repositoryId: string * pullRequestId: int * threadId: int * ?project: string -> Promise<Git.GitPullRequestCommentThread>
    /// <summary>Retrieve a list of work items associated with a pull request.</summary>
    /// <param name="repositoryId">- ID or name of the repository.</param>
    /// <param name="pullRequestId">- ID of the pull request.</param>
    /// <param name="project">- Project ID or project name</param>
    abstract getPullRequestWorkItemRefs: repositoryId: string * pullRequestId: int * ?project: string -> Promise<ResizeArray<WebApi.ResourceRef>>
    ...
    abstract getPush: repositoryId: string * pushId: int * ?project: string * ?includeCommits: int * ?includeRefUpdates: bool -> Promise<Git.GitPush>
    ...
    abstract getPushes: repositoryId: string * ?project: string * ?skip: int * ?top: int * ?searchCriteria: Git.GitPushSearchCriteria -> Promise<ResizeArray<Git.GitPush>>
    ...
    abstract deleteRefFavorite: project: string * favoriteId: int -> Promise<unit>
    /// <summary>Gets the refs favorite for a favorite Id.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="favoriteId">- The Id of the requested ref favorite.</param>
    abstract getRefFavorite: project: string * favoriteId: int -> Promise<Git.GitRefFavorite>
    ...
    /// <param name="repositoryId">- ID of the repository.</param>
    abstract getRevert: project: string * revertId: int * repositoryId: string -> Promise<Git.GitRevert>
    ...
    abstract getStatuses: commitId: string * repositoryId: string * ?project: string * ?top: int * ?skip: int * ?latestOnly: bool -> Promise<ResizeArray<Git.GitStatus>>
