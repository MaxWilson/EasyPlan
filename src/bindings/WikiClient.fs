...
type [<AllowNullLiteral>] WikiRestClient =
    ...
    abstract createCommentAttachment: content: obj option * project: string * wikiIdentifier: string * pageId: int -> Promise<Comments.CommentAttachment>
    /// <summary>Downloads an attachment on a comment on a wiki page.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="wikiIdentifier">- Wiki ID or wiki name.</param>
    /// <param name="pageId">- Wiki page ID.</param>
    /// <param name="attachmentId">- Attachment ID.</param>
    abstract getAttachmentContent: project: string * wikiIdentifier: string * pageId: int * attachmentId: string -> Promise<ArrayBuffer>
    ...
    abstract addCommentReaction: project: string * wikiIdentifier: string * pageId: int * commentId: int * ``type``: Comments.CommentReactionType -> Promise<Comments.CommentReaction>
    ...
    abstract deleteCommentReaction: project: string * wikiIdentifier: string * pageId: int * commentId: int * ``type``: Comments.CommentReactionType -> Promise<Comments.CommentReaction>
    ...
    abstract getEngagedUsers: project: string * wikiIdentifier: string * pageId: int * commentId: int * ``type``: Comments.CommentReactionType * ?top: int * ?skip: int -> Promise<ResizeArray<WebApi.IdentityRef>>
    /// <summary>Add a comment on a wiki page.</summary>
    /// <param name="request">- Comment create request.</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="wikiIdentifier">- Wiki ID or wiki name.</param>
    /// <param name="pageId">- Wiki page ID.</param>
    abstract addComment: request: Comments.CommentCreateParameters * project: string * wikiIdentifier: string * pageId: int -> Promise<Comments.Comment>
    /// <summary>Delete a comment on a wiki page.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="wikiIdentifier">- Wiki ID or name.</param>
    /// <param name="pageId">- Wiki page ID.</param>
    /// <param name="id">- Comment ID.</param>
    abstract deleteComment: project: string * wikiIdentifier: string * pageId: int * id: int -> Promise<unit>
    ...
    abstract getComment: project: string * wikiIdentifier: string * pageId: int * id: int * ?excludeDeleted: bool * ?expand: Comments.CommentExpandOptions -> Promise<Comments.Comment>
    ...
    abstract listComments: project: string * wikiIdentifier: string * pageId: int * ?top: int * ?continuationToken: string * ?excludeDeleted: bool * ?expand: Comments.CommentExpandOptions * ?order: Comments.CommentSortOrder * ?parentId: int -> Promise<Comments.CommentList>
    ...
    /// <param name="pageId">- Wiki page ID.</param>
    /// <param name="id">- Comment ID.</param>
    abstract updateComment: comment: Comments.CommentUpdateParameters * project: string * wikiIdentifier: string * pageId: int * id: int -> Promise<Comments.Comment>
    ...
    /// <param name="recursionLevel">- Recursion level for subpages retrieval. Defaults to \`None\` (Optional).</param>
    /// <param name="includeContent">- True to include the content of the page in the response for Json content type. Defaults to false (Optional)</param>
    abstract getPageByIdText: project: string * wikiIdentifier: string * id: int * ?recursionLevel: Git.VersionControlRecursionType * ?includeContent: bool -> Promise<string>
    /// <summary>Gets metadata or content of the wiki page for the provided page id. Content negotiation is done based on the \`Accept\` header sent in the request.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="wikiIdentifier">- Wiki ID or wiki name..</param>
    /// <param name="id">- Wiki page ID.</param>
    /// <param name="recursionLevel">- Recursion level for subpages retrieval. Defaults to \`None\` (Optional).</param>
    /// <param name="includeContent">- True to include the content of the page in the response for Json content type. Defaults to false (Optional)</param>
    abstract getPageByIdZip: project: string * wikiIdentifier: string * id: int * ?recursionLevel: Git.VersionControlRecursionType * ?includeContent: bool -> Promise<ArrayBuffer>
