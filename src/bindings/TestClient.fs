...
type [<AllowNullLiteral>] TestRestClient =
    ...
    abstract getActionResults: project: string * runId: int * testCaseResultId: int * iterationId: int * ?actionPath: string -> Promise<ResizeArray<Test.TestActionResultModel>>
    ...
    abstract updateCodeCoverageSummary: coverageData: Test.CodeCoverageData * project: string * buildId: int -> Promise<unit>
    ...
    abstract getTestIteration: project: string * runId: int * testCaseResultId: int * iterationId: int * ?includeActionResults: bool -> Promise<Test.TestIterationDetailsModel>
    /// <summary>Get iterations for a result</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="runId">- ID of the test run that contains the result.</param>
    /// <param name="testCaseResultId">- ID of the test result that contains the iterations.</param>
    /// <param name="includeActionResults">- Include result details for each action performed in the test iteration. ActionResults refer to outcome (pass/fail) of test steps that are executed as part of a running a manual test. Including the ActionResults flag gets the outcome of test steps in the actionResults section and test parameters in the parameters section for each test iteration.</param>
    abstract getTestIterations: project: string * runId: int * testCaseResultId: int * ?includeActionResults: bool -> Promise<ResizeArray<Test.TestIterationDetailsModel>>
    ...
    abstract getTestRunLogs: project: string * runId: int -> Promise<ResizeArray<Test.TestMessageLogDetails>>
    ...
    abstract getResultParameters: project: string * runId: int * testCaseResultId: int * iterationId: int * ?paramName: string -> Promise<ResizeArray<Test.TestResultParameterModel>>
    ...
    abstract getPoint: project: string * planId: int * suiteId: int * pointIds: int * ?witFields: string -> Promise<Test.TestPoint>
    ...
    abstract getPoints: project: string * planId: int * suiteId: int * ?witFields: string * ?configurationId: string * ?testCaseId: string * ?testPointIds: string * ?includePointDetails: bool * ?skip: int * ?top: int -> Promise<ResizeArray<Test.TestPoint>>
    ...
    abstract updateTestPoints: pointUpdateModel: Test.PointUpdateModel * project: string * planId: int * suiteId: int * pointIds: string -> Promise<ResizeArray<Test.TestPoint>>
    /// <summary>Get test points using query.</summary>
    /// <param name="query">- TestPointsQuery to get test points.</param>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="skip">- Number of test points to skip..</param>
    /// <param name="top">- Number of test points to return.</param>
    abstract getPointsByQuery: query: Test.TestPointsQuery * project: string * ?skip: int * ?top: int -> Promise<Test.TestPointsQuery>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="buildId">-</param>
    ...
    abstract getTestResultById: project: string * runId: int * testCaseResultId: int * ?detailsToInclude: Test.ResultDetails -> Promise<Test.TestCaseResult>
    ...
    abstract getTestRunById: project: string * runId: int * ?includeDetails: bool -> Promise<Test.TestRun>
    ...
    abstract getTestSessions: teamContext: Core.TeamContext * ?period: int * ?allSessions: bool * ?includeAllProperties: bool * ?source: Test.TestSessionSource * ?includeOnlyCompletedSessions: bool -> Promise<ResizeArray<Test.TestSession>>
    ...
    abstract deleteSharedParameter: project: string * sharedParameterId: int -> Promise<unit>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="sharedStepId">-</param>
    abstract deleteSharedStep: project: string * sharedStepId: int -> Promise<unit>
    ...
    abstract addTestCasesToSuite: project: string * planId: int * suiteId: int * testCaseIds: string -> Promise<ResizeArray<Test.SuiteTestCase>>
    ...
    abstract getTestCaseById: project: string * planId: int * suiteId: int * testCaseIds: int -> Promise<Test.SuiteTestCase>
    /// <summary>Get all test cases in a suite.</summary>
    /// <param name="project">- Project ID or project name</param>
    /// <param name="planId">- ID of the test plan that contains the suites.</param>
    /// <param name="suiteId">- ID of the suite to get.</param>
    abstract getTestCases: project: string * planId: int * suiteId: int -> Promise<ResizeArray<Test.SuiteTestCase>>
    ...
    abstract removeTestCasesFromSuiteUrl: project: string * planId: int * suiteId: int * testCaseIds: string -> Promise<unit>
    ...
    /// <param name="suiteId">- ID of the test suite to which the test cases must be added.</param>
    /// <param name="testCaseIds">- IDs of the test cases to add to the suite. Ids are specified in comma separated format.</param>
    abstract updateSuiteTestCases: suiteTestCaseUpdateModel: Test.SuiteTestCaseUpdateModel * project: string * planId: int * suiteId: int * testCaseIds: string -> Promise<ResizeArray<Test.SuiteTestCase>>
