...
type GenericJavascriptObject = obj
type RequestInit = GenericJavascriptObject // we don't have typing information for these, will have to ad-hoc it if necessary
type Response = GenericJavascriptObject
