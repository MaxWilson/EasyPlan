...
type [<AllowNullLiteral>] DashboardRestClient =
    ...
    abstract createDashboard: dashboard: Dashboard.Dashboard * teamContext: Core.TeamContext -> Promise<Dashboard.Dashboard>
    ...
    abstract deleteDashboard: teamContext: Core.TeamContext * dashboardId: string -> Promise<unit>
    /// <summary>Get a dashboard by its ID.</summary>
    /// <param name="teamContext">- The team context for the operation</param>
    /// <param name="dashboardId">-</param>
    abstract getDashboard: teamContext: Core.TeamContext * dashboardId: string -> Promise<Dashboard.Dashboard>
    /// <summary>Get a list of dashboards.</summary>
    /// <param name="teamContext">- The team context for the operation</param>
    abstract getDashboards: teamContext: Core.TeamContext -> Promise<Dashboard.DashboardGroup>
    ...
    abstract replaceDashboard: dashboard: Dashboard.Dashboard * teamContext: Core.TeamContext * dashboardId: string -> Promise<Dashboard.Dashboard>
    ...
    /// <param name="teamContext">- The team context for the operation</param>
    abstract replaceDashboards: group: Dashboard.DashboardGroup * teamContext: Core.TeamContext -> Promise<Dashboard.DashboardGroup>
    ...
    abstract createWidget: widget: Dashboard.Widget * teamContext: Core.TeamContext * dashboardId: string -> Promise<Dashboard.Widget>
    ...
    abstract deleteWidget: teamContext: Core.TeamContext * dashboardId: string * widgetId: string -> Promise<Dashboard.Dashboard>
    /// <summary>Get the current state of the specified widget.</summary>
    /// <param name="teamContext">- The team context for the operation</param>
    /// <param name="dashboardId">- ID of the dashboard containing the widget.</param>
    /// <param name="widgetId">- ID of the widget to read.</param>
    abstract getWidget: teamContext: Core.TeamContext * dashboardId: string * widgetId: string -> Promise<Dashboard.Widget>
    /// <summary>Override the  state of the specified widget.</summary>
    /// <param name="widget">- State to be written for the widget.</param>
    /// <param name="teamContext">- The team context for the operation</param>
    /// <param name="dashboardId">- ID of the dashboard containing the widget.</param>
    /// <param name="widgetId">- ID of the widget to update.</param>
    abstract replaceWidget: widget: Dashboard.Widget * teamContext: Core.TeamContext * dashboardId: string * widgetId: string -> Promise<Dashboard.Widget>
    ...
    /// <param name="dashboardId">- ID of the dashboard containing the widget.</param>
    /// <param name="widgetId">- ID of the widget to update.</param>
    abstract updateWidget: widget: Dashboard.Widget * teamContext: Core.TeamContext * dashboardId: string * widgetId: string -> Promise<Dashboard.Widget>
